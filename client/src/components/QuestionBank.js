...
const airNavigationOxfordBooks = [
  ...
  },
  {
    ...
    difficulty: "Medium",
    chapters: [
      // Question counts updated from actual JSON files (analyzed via analyze-question-counts.js)
      { id: 1, name: "Direction, Latitude and Longitude", questions: 5, difficulty: "Medium", pageStart: 1, pageEnd: 20 },
      { id: 2, name: "Great Circles, Rhumb Lines & Directions on the Earth", questions: 11, difficulty: "Medium", pageStart: 21, pageEnd: 42 },
      { id: 3, name: "Earth Magnetism", questions: 15, difficulty: "Medium", pageStart: 43, pageEnd: 66 },
      { id: 4, name: "The Navigation Computer - Slide Rule Face", questions: 23, difficulty: "Medium", pageStart: 67, pageEnd: 82 },
      { id: 5, name: "The Navigation Computer - Distance, Speed, Time and Conversions", questions: 5, difficulty: "Medium", pageStart: 83, pageEnd: 102 },
      { id: 6, name: "The Navigation Computer - TAS and Altitude Conversions", questions: 4, difficulty: "Medium", pageStart: 103, pageEnd: 122 },
      { id: 7, name: "The Navigation Computer - Triangle of Velocities", questions: 2, difficulty: "Medium", pageStart: 123, pageEnd: 136 },
      { id: 8, name: "The Navigation Computer - Calculation of Heading and Wind Finding", questions: 7, difficulty: "Medium", pageStart: 137, pageEnd: 166 },
      { id: 9, name: "The Navigation Computer - Multi-drift Winds and Wind Components", questions: 8, difficulty: "Medium", pageStart: 167, pageEnd: 186 },
      { id: 10, name: "The 1 in 60 Rule", questions: 12, difficulty: "Medium", pageStart: 187, pageEnd: 196 },
      { id: 11, name: "Navigation Using the 1 in 60 Rule", questions: 5, difficulty: "Medium", pageStart: 197, pageEnd: 208 },
      { id: 12, name: "Other Applications of the 1 in 60 Rule", questions: 8, difficulty: "Medium", pageStart: 209, pageEnd: 218 },
      ...
      { id: 16, name: "Scale", questions: 6, difficulty: "Medium", pageStart: 273, pageEnd: 280 },
      { id: 17, name: "General Chart Properties", questions: 0, difficulty: "Medium", pageStart: 281, pageEnd: 290 },
      { id: 18, name: "Mercator Charts - Properties", questions: 10, difficulty: "Medium", pageStart: 291, pageEnd: 306 },
      { id: 19, name: "Mercator Charts - Scale", questions: 14, difficulty: "Medium", pageStart: 307, pageEnd: 318 },
      ...
      { id: 22, name: "Lambert's Conformal Chart - 2", questions: 9, difficulty: "Medium", pageStart: 349, pageEnd: 362 },
