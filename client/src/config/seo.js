...
export const SEO_CONFIG = {
  ...
  questionBank: {
    ...
    description: "Comprehensive DGCA question bank for pilot license exams (CPL, ATPL) with thousands of practice questions for Air Regulations, Meteorology, Air Navigation, Technical General, Technical Specific, and Radio Telephony. Aviation exam questions and pilot exam questions with detailed solutions.",
  ...
  pyq: {
    ...
    description: "Practice DGCA previous year questions (PYQ) for pilot license exams (CPL, ATPL) with our comprehensive test series. Access PYQ sessions for Air Regulations, Meteorology, Air Navigation, and Technical General. Aviation mock tests and pilot exam practice tests.",
  ...
  library: {
    ...
    description: "Access comprehensive DGCA study materials, notes, books, and resources for all DGCA subjects. Study materials for Air Regulations, Meteorology, Air Navigation, and Technical subjects.",
